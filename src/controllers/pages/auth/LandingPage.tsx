...
export function LandingPage({ onNav }: { onNav: (s: Screen) => void }) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "Outfit, sans-serif" }}>
      ...
      {/* Hero */}
      <section className="relative min-h-screen flex items-center overflow-hidden pt-20" style={{ background: NAV }}>
        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-5xl font-extrabold text-gray-900" style={{ fontFamily: "Outfit, sans-serif" }}>Eventos destacados</h2>
      ...
      <footer style={{ background: NAV }} className="pt-14 pb-8 text-gray-400 text-sm">
        <div className="max-w-6xl mx-auto px-8">
          <div className="flex items-start justify-between gap-8 pb-10 border-b border-white/10">
